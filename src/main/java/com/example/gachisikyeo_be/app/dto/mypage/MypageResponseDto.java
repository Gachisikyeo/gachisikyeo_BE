...
public class MypageResponseDto {
    ...
    private final List<MypageGroupPurchaseDto> completedGroupPurchases;
    private final List<MypageGroupPurchaseDto> ongoingGroupPurchases;

    public MypageResponseDto(String nickname, String email, String lawDong, String userType, List<MypageGroupPurchaseDto> completedGroupPurchases, List<MypageGroupPurchaseDto> ongoingGroupPurchases) {
